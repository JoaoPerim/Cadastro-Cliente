...
module.exports = function (app) {
    ...
    app.get("/lista/cliente", async function (req, res, next) {
        try {
    ...
    app.get("/delete/cliente/:id", async function (req, res, next) {
        try {
    ...
    app.get("/edit/cliente/:id", async function (req, res, next) {
        try {
            var id = req.params.id;
