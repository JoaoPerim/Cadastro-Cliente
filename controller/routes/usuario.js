...
const CadastroUsuario = require('view/usuario/Login.ejs');
...
module.exports = function (app) {
    ...
    app.get("/lista/usuario", async function (req, res, next) {
        try {
    ...
    app.get("/delete/usuario/:id", async function (req, res, next) {
        try {
    ...
    app.get("/edit/usuario/:id", async function (req, res, next) {
        try {
            var id = req.params.id;
