...
module.exports = function (app) {
    ...
    app.get("/lista/produto", async function (req, res, next) {
        try {
    ...
    app.get("/delete/produto/:id", async function (req, res, next) {
        try {
    ...
    app.get("/edit/produto/:id", async function (req, res, next) {
        try {
            var id = req.params.id;
